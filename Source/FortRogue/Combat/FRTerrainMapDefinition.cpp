...
UFRTerrainMapDefinition::UFRTerrainMapDefinition()
{
...
void UFRTerrainMapDefinition::PostLoad()
{
	Super::PostLoad();
	NormalizeMapData();
}
...
#if WITH_EDITOR
void UFRTerrainMapDefinition::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UFRTerrainMapDefinition::Resize(int32 NewCellsX, int32 NewCellsZ)
{
...
void UFRTerrainMapDefinition::NormalizeMapData()
{
...
void UFRTerrainMapDefinition::ResizeResampled(int32 NewCellsX, int32 NewCellsZ)
{
	...
	for (FFREnemyPlacement& EnemyPlacement : EnemyPlacements)
	{
		EnemyPlacement.SpawnLocal = GetResampledSpawn(EnemyPlacement.SpawnLocal, SourceWidth, SourceHeight, TargetWidth, TargetHeight);
	}
}

void UFRTerrainMapDefinition::SetCellSizePreservingSpawns(float NewCellSize)
{
	NormalizeMapData();
...
void UFRTerrainMapDefinition::Clear(bool bSolid)
{
	SolidMask.Init(bSolid ? 1 : 0, CellsX * CellsZ);
	TextureLayerMask.Init(0, CellsX * CellsZ);
}

void UFRTerrainMapDefinition::FillRect(int32 MinX, int32 MinZ, int32 MaxX, int32 MaxZ, bool bSolid)
{
...
void UFRTerrainMapDefinition::FillTexturedRect(int32 MinX, int32 MinZ, int32 MaxX, int32 MaxZ, int32 LayerIndex)
{
	FillRect(MinX, MinZ, MaxX, MaxZ, true);
	ApplyTextureRect(MinX, MinZ, MaxX, MaxZ, LayerIndex);
}

void UFRTerrainMapDefinition::ApplyCircle(int32 CenterX, int32 CenterZ, int32 RadiusCells, bool bSolid)
{
...
void UFRTerrainMapDefinition::ApplyTexturedCircle(int32 CenterX, int32 CenterZ, int32 RadiusCells, int32 LayerIndex)
{
	ApplyCircle(CenterX, CenterZ, RadiusCells, true);
	ApplyTextureCircle(CenterX, CenterZ, RadiusCells, LayerIndex);
}

void UFRTerrainMapDefinition::ApplyCircleStroke(int32 StartX, int32 StartZ, int32 EndX, int32 EndZ, int32 RadiusCells, bool bSolid)
{
...
void UFRTerrainMapDefinition::ApplyTexturedCircleStroke(int32 StartX, int32 StartZ, int32 EndX, int32 EndZ, int32 RadiusCells, int32 LayerIndex)
{
	const int32 StepCount = FMath::Max(FMath::Abs(EndX - StartX), FMath::Abs(EndZ - StartZ));
	if (StepCount <= 0)
	{
...
void UFRTerrainMapDefinition::SetTextureLayer(int32 LayerIndex, UTexture2D* Texture)
{
	if (LayerIndex < 0)
	{
		return;
	...
	FFRTerrainTextureLayer& Layer = TextureLayers[ClampedLayerIndex];
...
void UFRTerrainMapDefinition::ApplyTextureRect(int32 MinX, int32 MinZ, int32 MaxX, int32 MaxZ, int32 LayerIndex)
{
...
void UFRTerrainMapDefinition::ApplyTextureCircle(int32 CenterX, int32 CenterZ, int32 RadiusCells, int32 LayerIndex)
{
	const uint8 ClampedLayer = static_cast<uint8>(FMath::Clamp(LayerIndex, 0, 255));
	const int32 Radius = FMath::Max(0, RadiusCells);
	const int32 RadiusSq = Radius * Radius;
...
void UFRTerrainMapDefinition::ApplyTextureCircleStroke(int32 StartX, int32 StartZ, int32 EndX, int32 EndZ, int32 RadiusCells, int32 LayerIndex)
{
	const int32 StepCount = FMath::Max(FMath::Abs(EndX - StartX), FMath::Abs(EndZ - StartZ));
	if (StepCount <= 0)
	{
...
bool UFRTerrainMapDefinition::ImportSolidMaskFromTexture(UTexture2D* SourceTexture, bool bUseAlpha, float Threshold, int32 LayerIndex, bool bResizeToTexture)
{
	return ImportSolidMaskFromTextureRegion(SourceTexture, 0, 0, 0, 0, bUseAlpha, Threshold, LayerIndex, bResizeToTexture);
}

bool UFRTerrainMapDefinition::ImportSolidMaskFromTextureByColor(UTexture2D* SourceTexture, FLinearColor TargetColor, float Tolerance, int32 LayerIndex, bool bResizeToTexture)
{
	return ImportSolidMaskFromTextureRegionByColor(SourceTexture, 0, 0, 0, 0, TargetColor, Tolerance, LayerIndex, bResizeToTexture);
}

bool UFRTerrainMapDefinition::ImportSolidMaskFromTextureRegion(UTexture2D* SourceTexture, int32 SourceMinX, int32 SourceMinY, int32 SourceWidth, int32 SourceHeight, bool bUseAlpha, float Threshold, int32 LayerIndex, bool bResizeToRegion)
{
	TArray<FColor> Pixels;
	int32 TextureWidth = 0;
	int32 TextureHeight = 0;
...
bool UFRTerrainMapDefinition::ImportSolidMaskFromTextureRegionByColor(UTexture2D* SourceTexture, int32 SourceMinX, int32 SourceMinY, int32 SourceWidth, int32 SourceHeight, FLinearColor TargetColor, float Tolerance, int32 LayerIndex, bool bResizeToRegion)
{
	TArray<FColor> Pixels;
	int32 TextureWidth = 0;
	int32 TextureHeight = 0;
...
bool UFRTerrainMapDefinition::IsValidCell(int32 X, int32 Z) const
{
	return X >= 0 && X < CellsX && Z >= 0 && Z < CellsZ;
}

int32 UFRTerrainMapDefinition::ToIndex(int32 X, int32 Z) const
{
	return Z * CellsX + X;
}
