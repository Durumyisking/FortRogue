...
#include "FRAssetManager.h"

#include "FortRogue.h"
#include "Engine/AssetManagerSettings.h"

void UFRAssetManager::StartInitialLoading()
{
...
void UFRAssetManager::HandleCompletedInitialScan()
{
...
bool UFRAssetManager::ShouldDumpInitialScanState()
{
...
void UFRAssetManager::DumpInitialScanState() const
{
