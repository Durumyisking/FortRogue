...
bool FFortRogueTerrainMapDefinitionEditTest::RunTest(const FString& Parameters)
{
	...
	ConditionShotSpec.EffectTags.AddTag(FortRogueGameplayTags::Weapon_Shell);
	FFortRogueShotModifierSpec ConditionModifier;
	ConditionModifier.RequiredShotTags.AddTag(FortRogueGameplayTags::Weapon_Shell);
	TestTrue(TEXT("Shot modifier condition helper accepts required shot tags"), ConditionModifier.MeetsShotConditions(ConditionShotSpec, 45.0f, 0.0f, true));
	...
	TestFalse(TEXT("Shot modifier condition helper rejects blocked shot tags"), ConditionModifier.MeetsShotConditions(ConditionShotSpec, 45.0f, 0.0f, true));
